...
import com.cgens67.innertube.models.comment.CommentThreadRenderer
import com.cgens67.innertube.models.comment.CommentResponse
...
object YouTube {
    ...
    var ipVersion: com.cgens67.innertube.models.IpVersion
            ...
            mutation.payload?.commentEntityPayload?.let { payload ->
                ...
                CommentThreadRenderer(
                    comment = CommentThreadRenderer.Comment(
                        commentRenderer = com.cgens67.innertube.models.comment.CommentRenderer(
                            authorText = com.cgens67.innertube.models.Runs(
                                runs = listOf(com.cgens67.innertube.models.Run(text = payload.author?.displayName ?: "Unknown", navigationEndpoint = null))
                            ),
                            authorThumbnail = com.cgens67.innertube.models.Thumbnails(
                                thumbnails = listOf(com.cgens67.innertube.models.Thumbnail(url = payload.author?.avatarThumbnailUrl ?: "", width = 0, height = 0))
                            ),
                            contentText = com.cgens67.innertube.models.Runs(
                                runs = listOf(com.cgens67.innertube.models.Run(text = payload.properties?.content?.content ?: "", navigationEndpoint = null))
                            ),
                            publishedTimeText = com.cgens67.innertube.models.Runs(
                                runs = listOf(com.cgens67.innertube.models.Run(text = payload.properties?.publishedTime ?: "", navigationEndpoint = null))
                            ),
                            commentId = commentId,
                            voteCount = com.cgens67.innertube.models.Runs(
                                runs = listOf(com.cgens67.innertube.models.Run(text = likeCount, navigationEndpoint = null))
                            ),
    ...
    suspend fun commentReplies(replyToken: String): Result<Pair<List<com.cgens67.innertube.models.comment.CommentRenderer>, String?>> = runCatching {
        ...
        val frameworkReplies = mutations.mapNotNull { mutation ->
            mutation.payload?.commentEntityPayload?.let { payload ->
                ...
                com.cgens67.innertube.models.comment.CommentRenderer(
                    authorText = com.cgens67.innertube.models.Runs(
                        runs = listOf(com.cgens67.innertube.models.Run(text = payload.author?.displayName ?: "Unknown", navigationEndpoint = null))
                    ),
                    authorThumbnail = com.cgens67.innertube.models.Thumbnails(
