...
fun LyricsV2(
    ...
    val originalLyrics = remember(currentLyrics) {
        var text = currentLyrics?.lyrics?.trim()
    ...
    val lyricsOffsetMs = remember(currentLyrics) {
        val raw = currentLyrics?.lyrics.orEmpty()
