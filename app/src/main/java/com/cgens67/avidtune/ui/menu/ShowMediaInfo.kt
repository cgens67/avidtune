...
fun ColumnScope.ShowMediaInfo(videoId: String, onClose: () -> Unit) {
    ...
    LazyColumn(Modifier.weight(1f, fill = false).fillMaxWidth(), rememberLazyListState(), PaddingValues(16.dp, 0.dp, 16.dp, 24.dp), verticalArrangement = Arrangement.spacedBy(16.dp)) {
