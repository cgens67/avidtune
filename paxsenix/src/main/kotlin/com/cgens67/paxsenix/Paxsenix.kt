package com.cgens67.paxsenix

import android.content.Context
import com.cgens67.music.betterlyrics.TTMLParser
import com.cgens67.paxsenix.models.AppleMusicSearchResponse
import com.cgens67.paxsenix.models.LyricsResponse

import com.cgens67.paxsenix.models.SearchResult
        ...
        synchronized(this) {
            ...
            client = HttpClient(CIO) {
                ...
                defaultRequest {
                    ...
                    header("User-Agent", "Cgens67/$appVersion")
                }
